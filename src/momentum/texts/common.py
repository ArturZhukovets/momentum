...
HELP = (
    ...
    "1️⃣ /goal — Ты устанавливаешь свои цели.\n"
    "2️⃣ /add — выбираешь тип тренировки: 🏃 Бег, 🏊 Плавание, 🌀 Эллипсоид, "
    "💪 Зал и другие виды тренировок.\n"
    "3️⃣ Я спрашиваю только то, что подходит этому типу: длительность, дистанцию, "
    "нагрузку или группы мышц — и в конце описание и дату.\n"
    "4️⃣ Любой вопрос можно пропустить — записать тренировку в два нажатия тоже нормально.\n"
    "5️⃣ /measure — раз в неделю фиксируешь вес и делаешь замеры (по желанию), я считаю прогресс к цели.\n\n"
